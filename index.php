                      ...
                      <div class="ps-shoe__content">
                        ...
                        <div class="ps-shoe__detail"><a class="ps-shoe__name" href="#"><?php echo $shoe['shoe_name'] ?></a>
                          ...
                          <span class="ps-shoe__price">
                              <?php 
                                  if($shoe['sale'] > 0){
                                      echo '<del>'.number_format($shoe['price'], 0, ',', '.').' VND</del>';
                                  }
                                  echo number_format(($shoe['price'] - $shoe['price']*$shoe['sale']*0.01), 0, ',', '.')." VND";
                              ?>
                          </span>
            ...
            <div class="row">
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
                    <aside class="ps-widget--footer ps-widget--info">
                      ...
                      <footer>
                        <p><strong>300A Nguyễn Tất Thành, Phường 13, Quận 4.</strong></p>
                        <p>Email: <a href='mailto:support@store.com'>2000004365@nttu.edu.vn</a></p>
                        <p>Phone: 0889821918</p>
                      </footer>
                    </aside>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 ">
