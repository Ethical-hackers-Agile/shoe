                          ...
                          <?php
                            if(isset($_POST['submit_payment'])){
                              ...
                              try {
                                  ...
                                  $mail->Password = 'your_password'; // Thay bằng mật khẩu của bạn
                                  $mail->SMTPSecure = 'tls';
                                  $mail->Port = 587;

                                  // Thiết lập thông tin người gửi và người nhận
                                  $mail->setFrom('your_email@gmail.com', 'Your Name'); // Thay bằng email và tên của bạn
                                  $mail->addAddress($infoUser['email'], $infoUser['name']); // Thay bằng email và tên của người nhận
